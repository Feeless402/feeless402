---
name: nano-pay
description: Pay for x402-priced HTTP APIs (HTTP 402 Payment Required) with feeless, sub-second Nano (XNO) micropayments from a self-custodied local wallet. Use when an API returns 402, when you need pay-per-call access to a paid endpoint (e.g. nano-gpt.com), or when the user asks to send/receive/top-up Nano.
---
